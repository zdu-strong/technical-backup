...
Use java, springboot and CockroachDB to build back-end projects.<br/>
For implementation examples utilizing mysql and Google Spanner, please refer to the alternative branches.<br/>
