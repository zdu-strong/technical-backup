...
Use java, springboot and Google Spanner to build back-end projects.<br/>
For implementation examples utilizing mysql and CockroachDB, please refer to the alternative branches.<br/>
...
use typescript and cypress to write automated tests for dioxus project
